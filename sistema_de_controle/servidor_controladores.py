    ...
    while True:
        try:
            ...
            if '%' not in data:
                ...
                controlador =  input('escolha um controlador(fuzzy, pid ou fuzzypdi): ')
                if controlador == 'pid':
                    try:
                    ...
                    try:
                        ...
                        # Usa o controlador fuzzy pd+i
                        acao_fuzzy_pdi = modulo_fuzzypdi.calcular_dosagem(density_value, set_point)
                        dosagem  = acao_fuzzy_pdi[0]
                        tipo  = acao_fuzzy_pdi[1]
                        resposta = f"{dosagem} mA,{tipo}"
